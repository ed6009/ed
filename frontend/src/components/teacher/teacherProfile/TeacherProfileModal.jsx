...
const TeacherProfileModal = (props) => {
  ...
  function getSingleTchrProfileData(teacher_id) {
  ...
  const handleShowProfile = () => {
    if (profile.length === 0) {
      document.getElementById(`alert_${props.teacher_id}`).showModal();
    } else {
  ...
  return (
    <>
      ...
      <dialog id={`alert_${props.teacher_id}`} className="modal">
        <div className="modal-box">
          ...
          <div role="alert" className="alert alert-error">
            ...
            <span className="text-white">
              Error! Please insert profile data.
            </span>
          </div>
        </div>
