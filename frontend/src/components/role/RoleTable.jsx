...
const EditRoleModal = ({ role, patchRole }) => {
  const [role_id, setRole_id] = useState(role.role_id);
  const [role_name, setRole_name] = useState(role.role_name);
...
const RoleTable = () => {
        ...
        Cell: ({ row }) => (
          <div className="flex items-center justify-center">
            <button
              ...
              onClick={() =>
                document
                  .getElementById(`my_modal_${row.original.role_id}`)
                  .showModal()
              }
            >
              <svg
            ...
            <EditRoleModal role={row.original} patchRole={patchRole} />
          </div>
        ),
      },
    ],
  ...
  const patchRole = useCallback((role_id, updatedData) => {
    ...
    <div>
      ...
      <div className="mx-8 border border-gray-300 rounded-lg table-container">
        <div className="flex items-center justify-between pb-2 mx-20 mt-2 shadow-sm">
          <h1 className="items-center text-xl font-semibold">All Roles List</h1>
          <AddRoleModal fetchRoleData={fetchRoleData} />
        </div>
        <div className="flex items-center justify-between pb-2 mx-20 mt-2 shadow-sm">
